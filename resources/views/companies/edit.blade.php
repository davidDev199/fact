    ...
    <form action="{{ route('companies.update', $company) }}" method="POST" enctype="multipart/form-data">
        ...
        <x-wire-card>
            ...
            <div class="space-y-4 mb-4">
                ...
                <x-wire-input name="ruc" value="{{ old('ruc', $company->ruc) }}" />

                <x-wire-input name="razonSocial" value="{{ old('razonSocial', $company->razonSocial) }}" />

                <x-wire-input name="nombreComercial"
                    value="{{ old('nombreComercial', $company->nombreComercial) }}" />

                <x-wire-input name="direccion" value="{{ old('direccion', $company->direccion) }}" />
